        ...
        if isinstance(val, list):
            ...
            try:
                ...
                error = {
                    ...
                    "message": f"input인 {val}을 {type_input} 타입으로 변환하는데 실패했습니다.",
                    "details": f"{x}, {val}, {ex}",
                    "extra_info": {
                        "input_name": x,
                        "input_config": info,
            ...
            if x not in validate_function_inputs and not validate_has_kwargs:
                if "min" in extra_info and val < extra_info["min"]:
                    error = {
                        ...
                        "message": f"{val}이 최소값인 {extra_info['min']}보다 커야합니다.",
                        "details": f"{x}",
                        "extra_info": {
                            "input_name": x,
                            "input_config": info,
                ...
                if "max" in extra_info and val > extra_info["max"]:
                    error = {
                        ...
                        "message": f"{val}이 최대값인 {extra_info['max']}보다 작아야합니다.",
                        "details": f"{x}",
                        "extra_info": {
                            "input_name": x,
                            "input_config": info,
        ...
        if valid is True:
            ...
            for node_id, result in validated.items():
                ...
                if valid is not True and len(reasons) > 0:
                    ...
                    node_errors[node_id]["error_type"] = None
